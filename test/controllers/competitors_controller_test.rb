...
class CompetitorsControllerTest < ActionController::TestCase
  ...
  test "should create competitor" do
    assert_difference('Competitor.count') do
      post :create, competitor: { description: @competitor.description, funding: @competitor.funding, name: @competitor.name, url: @competitor.url }
    end
  ...
  test "should update competitor" do
    patch :update, id: @competitor, competitor: { description: @competitor.description, funding: @competitor.funding, name: @competitor.name, url: @competitor.url }
    assert_redirected_to competitor_path(assigns(:competitor))
  end
